...
//	private Logger logger = LoggerFactory.getLogger(PostBO.class);
	...
	public Post getPostById(int postId) {
		return postDAO.selectPostByLoginId(postId);
	}
	
	public int addPost(String loginId, int userId, String subject, String content, MultipartFile file) {
